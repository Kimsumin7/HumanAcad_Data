...
<table border="1" width="90%" id="customers">
    ...
    <fmt:parseDate value="${requestScope.dto.birthday}" pattern="yyyy-MM-dd'T'HH:mm" var="now" type="both" ></fmt:parseDate>
    <tr>
...
<a href="/jsp18/customerHobby/selectAll.customerHobby">목록가기</a>
<a href="/jsp18/customerHobby/deleteCustomer.customerHobby?id=${requestScope.dto.id}">고객삭제</a>
<a href="/jsp18/customerHobby/deleteHobby.customerHobby?id=${requestScope.dto.id}&hobby=${requestScope.dto.hobby.hobby}">하비삭제</a>
</body>
</html>
