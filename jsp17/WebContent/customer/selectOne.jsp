...
<a href="/jsp17/customer/selectAll.customer">목록가기</a>
<a href="/jsp17/customer/update.customer?id=${requestScope.dto.id }">수정하기</a>
<a href="/jsp17/customer/delete.customer?id=${requestScope.dto.id }">삭제하기</a>
</body>
</html>